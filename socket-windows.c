...
int main(int argc, char *argv[])
{
	...
	test_socket(HostName);
	return 0;
}

void test_socket(char *pszHostName)
{
...
/*
SocketData.szDescription  = WinSocImplementationInfo;
SocketData.szSystemStatus = WinSocConfigInfo;
*/	
